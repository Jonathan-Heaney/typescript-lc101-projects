...
var Spacecraft = /** @class */ (function () {
  ...
  Spacecraft.prototype.printDaysToLocation = function (location) {
    console.log(
      ''
        .concat(this.name, ' would take ')
        .concat(
          this.getDaysToLocation(location.kilometersAway),
          ' days to get to '
        )
...
spaceShuttle.printDaysToLocation(
  new SpaceLocation_1.SpaceLocation('Mars', kilometersToMars)
);
spaceShuttle.printDaysToLocation(
  new SpaceLocation_1.SpaceLocation('the Moon', kilometersToTheMoon)
);
